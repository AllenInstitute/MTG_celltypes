...
```{r setwd}
homeFolder <- "Z:/hct/HCT_RNAseq/Jeremy/MTG_celltypes/MTG_celltypes/"  # UPDATE WITH CORRECT PATH
...
# Write data file
write_feather(data,paste0(homeFolder,"MTG/data.feather"))
```
...
# Write data file
write_feather(data,paste0(homeFolder,"mouse/data.feather"))
```
